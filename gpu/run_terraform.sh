...
export TF_VAR_availability_zone=${OS_AVAILABILITY_ZONE:-"tasmania-02"} # Default to "tasmania-02" if not set
...
echo "TF_VAR_availability_zone is set to '$TF_VAR_availability_zone'"
